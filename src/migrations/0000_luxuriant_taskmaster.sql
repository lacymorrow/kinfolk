...
ALTER TABLE "db_address" ADD CONSTRAINT "db_address_person_id_db_person_id_fk" FOREIGN KEY ("person_id") REFERENCES "public"."db_person"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "db_contact" ADD CONSTRAINT "db_contact_person_id_db_person_id_fk" FOREIGN KEY ("person_id") REFERENCES "public"."db_person"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "db_person" ADD CONSTRAINT "db_person_family_id_db_family_id_fk" FOREIGN KEY ("family_id") REFERENCES "public"."db_family"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "db_person" ADD CONSTRAINT "db_person_user_id_db_user_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."db_user"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "db_relationship" ADD CONSTRAINT "db_relationship_person_id_db_person_id_fk" FOREIGN KEY ("person_id") REFERENCES "public"."db_person"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "db_relationship" ADD CONSTRAINT "db_relationship_related_id_db_person_id_fk" FOREIGN KEY ("related_id") REFERENCES "public"."db_person"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "waitlist_is_notified_idx" ON "db_waitlist_entry" USING btree ("is_notified");